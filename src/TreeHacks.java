...
public class TreeHacks {
	...
	private static void initScenes()
	{
		...
		String[][] linkPrompts = {{"","","",""},//left, right, door, keypad
								{"You're shocked to see a man chained to the wall! He clearly needs help. You think you can hear him mumbling something","",""},//left, right, desk
								{"","","To give the man an item in your inventory, click the item, then click the man."},//left, right, man
								{"","",""},//left, right, bookshelf
								{"You hit a few numbers, but nothing happens",
									"The door doesn't seem to have a door handle. Besides, it looks locked",""},//keypad, door, back
								{""},{""},{""}};//back
		...
		sceneDict.put("book", "de livre");
		sceneDict.put("papers", "de papiers");
		...
		final Reception finalReception = new Reception(){
			public void react(NPC receptor) {
				...
				try {
				    ...
				    showText("You help the man to 'la porte', and he types in the code to the door.\n\n" +
